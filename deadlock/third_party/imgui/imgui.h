...
struct ImDrawList
{
    ...
    IMGUI_API void AddRectFilledMultiColorRounded( const ImVec2& p_min, const ImVec2& p_max, ImU32 bg_color,
                                                   ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right,
                                                   ImU32 col_bot_left, float rounding, ImDrawFlags rounding_corners );
    ...
    IMGUI_API void AddText( const ImFont* font, float font_size, const ImVec2& pos, const ImDrawGradient& paint,
